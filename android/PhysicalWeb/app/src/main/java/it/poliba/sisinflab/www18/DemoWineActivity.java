 ...
 */
public class DemoWineActivity extends Activity {

    private String TAG = DemoWineActivity.class.getName();

    static private KBManager mKBManager = null;
    static private BeaconDatabase mDB = null;

    public static BeaconDatabase getDatabase() {
        return mDB;
    }
    ...
    private final View.OnTouchListener mDelayHideTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent intent = new Intent(getBaseContext(), DemoTabActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDB = new BeaconDatabase(getBaseContext());
        setContentView(R.layout.activity_demo_wine);
        ...
        findViewById(R.id.get_started).setOnTouchListener(mDelayHideTouchListener);

        new Thread(new Runnable() {
            @Override
            public void run()
            {
                mKBManager = new KBManager(getBaseContext(), R.raw.wine_ontology_www18);
                mKBManager.loadCustomRequest();
            }
        }).start();
    }
